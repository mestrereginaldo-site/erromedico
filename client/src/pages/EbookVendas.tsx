...
export default function EbookVendas() {
  ...
  return (
    <div id="top" className="min-h-screen bg-gradient-to-br from-[#1A365D] to-[#0F172A] text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 py-3 flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <div className="bg-red-600 text-white px-3 py-1 rounded-full text-sm font-bold animate-pulse">
              ⚠️ {copiesLeft} COPIA{SCOPIES_LEFT > 1 ? 'S' : ''} RESTANTE{SCOPIES_LEFT > 1 ? 'S' : ''}
            </div>
            <nav className="flex space-x-6">
              <a href="#beneficios" onClick={(e) => {
                e.preventDefault();
                document.getElementById('beneficios')?.scrollIntoView({behavior: 'smooth'});
              }} className="hover:text-yellow-400 font-semibold transition-colors text-sm">Benefícios</a>
              <a href="#investimento" onClick={(e) => {
                e.preventDefault();
                document.getElementById('investimento')?.scrollIntoView({behavior: 'smooth'});
              }} className="hover:text-yellow-400 font-semibold transition-colors text-sm">Oferta</a>
              <a href="#depoimentos" onClick={(e) => {
                e.preventDefault();
                document.getElementById('depoimentos')?.scrollIntoView({behavior: 'smooth'});
              }} className="hover:text-yellow-400 font-semibold transition-colors text-sm">Depoimentos</a>
            </nav>
          </div>
        </div>
      </header>
      ...
      {/* Features Section - Mantida mas com pequenos ajustes */}
      <section id="beneficios" className="py-20 bg-gradient-to-b from-[#0F172A] to-[#1E293B]">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Os cards de benefícios permanecem iguais, mas você pode adicionar: */}
            <div className="bg-white/5 border border-white/10 rounded-xl p-8 transition-transform hover:-translate-y-2 duration-300 relative">
              ...
              <h3 className="text-xl font-bold mb-3">Modelos Editáveis</h3>
              <p className="text-gray-300">
                Petições, cálculos e documentos prontos para usar - só preencher seus dados.
              </p>
            </div>
      ...
      {/* Seção do Autor - CRUCIAL para credibilidade */}
      ...
      <section id="investimento" className="py-20 bg-gradient-to-b from-[#0F172A] to-[#1E293B]">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="bg-white/5 border-2 border-yellow-400/30 rounded-2xl p-8 md:p-12 max-w-2xl mx-auto relative shadow-2xl">
            ...
            {/* Conteúdo do pricing permanece similar, mas com mais destaque para a garantia */}
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="bg-gradient-to-r from-green-600/20 to-blue-600/20 border border-green-500/30 rounded-2xl p-8 text-center">
            ...
            <p className="text-lg mb-6">
              Você tem <strong>7 dias inteiros</strong> para testar o guia. Se por qualquer motivo não achar que vale <strong>10x o investimento</strong>, devolvemos 100% do seu dinheiro.
            </p>
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="space-y-6">
            <div className="bg-white/5 border border-white/10 rounded-xl p-6">
              ...
              <p className="text-gray-300">Imediatamente após a confirmação do pagamento pelo WhatsApp, você recebe o link de acesso para baixar o guia completo.</p>
            </div>
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 max-w-md mx-auto">
            <div className="text-center mb-6">
              ...
              <p className="text-green-400 font-semibold mb-2">🎁 BÔNUS: Modelos Editáveis Inclusos</p>
              <p className="text-sm text-gray-300 mb-4">⏰ Oferta termina em: {formatTime(timeLeft)}</p>
            </div>
            
            <a 
              href="https://wa.me/5571996510966?text=Olá!%20Quero%20garantir%20o%20GUIA%20COMPLETO%20com%2060%25%20de%20desconto%20antes%20que%20acabe!%20Como%20faço%20para%20comprar?" 
              target="_blank"
              rel="noopener noreferrer"
            ...
            <div className="text-center mt-4">
              <img src="/assets/checkout-seguro.png" alt="Checkout Seguro" className="h-8 mx-auto opacity-70" />
      ...
      <a 
        href="https://wa.me/5571996510966?text=Olá!%20Tenho%20dúvidas%20sobre%20o%20Guia%20Completo%20de%20Indenização%20por%20Erro%20Médico.%20Pode%20me%20ajudar?" 
        target="_blank"
        rel="noopener noreferrer"
